...
public class App 
{
	public static String account = "chenjiazheng0310@163.com";			//替换为发件人账号
    public static String password = "RHFNVSMBOPJQMEYR";					//替换为发件人账号密码
    ...
    public static MimeMessage createMimeMessage(String code,Session session, String sendMail, String receiveMail)
        ...
        // 5. Content: 邮件正文
        message.setContent("用户你好,爱旅行！！", "text/html;charset=UTF-8");
        // 6. 设置发件时间
